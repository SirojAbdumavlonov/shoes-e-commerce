...
/**
 * REST controller for managing {@link com.shoes.domain.CustomerDetails}.
 */
@RestController
...
public class CustomerDetailsResource {
    ...
    public ResponseEntity<CustomerDetails> partialUpdateCustomerDetails(
        ...
        Optional<CustomerDetails> result = customerDetailsRepository
            .findById(customerDetails.getId())
            .map(existingCustomerDetails -> {
                if (customerDetails.getFirstName() != null) {
                    existingCustomerDetails.setFirstName(customerDetails.getFirstName());
                }
                if (customerDetails.getSecondName() != null) {
                    existingCustomerDetails.setSecondName(customerDetails.getSecondName());
                }
                ...
                if (customerDetails.getDateOfBirth() != null) {
                    existingCustomerDetails.setDateOfBirth(customerDetails.getDateOfBirth());
                }
