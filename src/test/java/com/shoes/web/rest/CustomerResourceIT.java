...
import static com.shoes.domain.CustomerAsserts.*;
...
import com.shoes.domain.Customer;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().email(DEFAULT_EMAIL).password(DEFAULT_PASSWORD).createdAt(DEFAULT_CREATED_AT);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().email(UPDATED_EMAIL).password(UPDATED_PASSWORD).createdAt(UPDATED_CREATED_AT);
        return customer;
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.email(UPDATED_EMAIL).password(UPDATED_PASSWORD).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.email(UPDATED_EMAIL).password(UPDATED_PASSWORD).createdAt(UPDATED_CREATED_AT);
